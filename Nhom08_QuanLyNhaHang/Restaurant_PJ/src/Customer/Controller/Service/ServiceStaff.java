...
import Customer.Model.ModelCTNK;
import Customer.Model.ModelCTXK;
import Customer.Model.ModelHoaDon;
import Customer.Model.ModelKhachHang;
import Customer.Model.ModelKho;
import Customer.Model.ModelNguyenLieu;
import Customer.Model.ModelNhanVien;
import Customer.Model.ModelPNK;
import Customer.Model.ModelPXK;
...
public class ServiceStaff {
    ...
    public ModelNhanVien getStaff(int userID) throws SQLException {
        ...
        String sql = "SELECT ID_NV, TenNV, CONVERT(VARCHAR, NGAYVAOLAM, 105) AS Ngay, SDT, Chucvu, ID_NQL FROM NhanVien WHERE ID_ND=?";
